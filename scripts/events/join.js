module.exports.config = {
  ...
  version: "1.0.0",
  credits: "Mirai-Team", // FIXED BY ARIF
...
.then(response => {
    ...
    return api.sendMessage(" আসসালমুআলাইকুম চলে এসেছি আমি আরিফ আপনাদের মাঝে🤭!", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME} CONNECTED«\n\nAssalamualaykum☘️
<------------------------------>  
...
DEVELOPER :Mohammad ARIF 

🟣Facebook Account Link: 

https://www.facebook.com/exrout

🔵WHATSAPP NUMBER: wa.me/+8801868342143

🟢SUPPORT EMAIL: www.pepsbazar@gmail.com`, attachment: fs.createReadStream(gifPath)}, threadID));
})
.catch(error => {
    console.error(error);
});
